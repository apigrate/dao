...
class Dao{
  ...
  */
  ...
  /**
    ...
    @param save to save. Only the attributes provided are updated (i.e. performs
    ...
    @param criteria the filter object used to build the WHERE clause identifying objects
